...
router.post("/send-otp-phone", (0, validate_middleware_1.default)(authValidation.sendOtpByPhone), authController.sendOtpByPhone);
router.post("/verify-otp", (0, validate_middleware_1.default)(authValidation.verifyOtp), authController.verifyOtp);
router.post("/verify-otp-phone", (0, validate_middleware_1.default)(authValidation.verifyOtpByPhone), authController.verifyOtpByPhone);
...
router.post("/login-phone", (0, validate_middleware_1.default)(authValidation.loginByPhone), authController.loginByPhone);
